    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at 40% 50%, rgba(225,29,72,0.12) 0%, transparent 50%), radial-gradient(ellipse at 70% 70%, rgba(59,130,246,0.1) 0%, transparent 50%), linear-gradient(180deg, #0a0a0a 0%, #1a1a2e 60%, #0a0a0a 100%)',
          }}
        />
