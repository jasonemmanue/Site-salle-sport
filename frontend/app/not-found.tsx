  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="relative">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-2 rounded-xl gradient-primary px-8 py-3.5 text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-primary/30 hover:scale-105"
        >
