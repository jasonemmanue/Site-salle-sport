...
const mockTransformations: Transformation[] = [
  {
    ...
    before_image_url: "",
    after_image_url: "",
    testimonial: "En 6 mois chez Eslie Sport, j'ai perdu 15 kg et gagne une confiance en moi incroyable. Les coachs sont exceptionnels et le programme personnalise a fait toute la difference.",
  ...
  },
  {
    ...
    before_image_url: "",
    after_image_url: "",
    testimonial: "A 52 ans, je suis en meilleure forme qu'a 30. Le programme senior de Eslie Sport m'a permis de retrouver energie et vitalite au quotidien.",
  ...
  },
  {
    ...
    before_image_url: "",
    after_image_url: "",
    testimonial: "De sedentaire total a coureur de semi-marathon en 10 mois. Les coachs de Eslie Sport m'ont pousse a me depasser chaque jour.",
