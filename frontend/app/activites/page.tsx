...
const mockActivities: Activity[] = [
  {
    ...
    name: 'Musculation',
    slug: 'musculation',
    description: 'Renforcez votre masse musculaire avec nos equipements de qualite. Coach Toussaint vous accompagne tous les jours de 6h a 21h.',
    category: 'force',
    level: 'all',
    duration_minutes: 90,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Fitness',
    slug: 'fitness',
    description: 'Seances dynamiques pour ameliorer votre condition physique generale. Coach Leo vous attend les lundis, mercredis et vendredis de 21h a 22h.',
    category: 'cardio',
    level: 'all',
    duration_minutes: 60,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Zumba',
    slug: 'zumba',
    description: 'Dansez, bougez, amusez-vous ! Un cours energique sur des rythmes latinos avec Coach Adonis chaque jeudi a 18h.',
    category: 'dance',
    level: 'beginner',
    duration_minutes: 90,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Kick Boxing',
    slug: 'kick-boxing',
    description: 'Apprenez les techniques de kick boxing avec Coach David. Cours les mercredis et samedis a 16h.',
  ...
  },
  {
    ...
    name: 'Wushu',
    slug: 'wushu',
    description: 'Art martial chinois traditionnel avec Maitre Kabore. Discipline, souplesse et maitrise de soi les mercredis et samedis de 15h a 16h.',
    category: 'martial_arts',
    level: 'all',
    duration_minutes: 60,
    max_capacity: 15,
