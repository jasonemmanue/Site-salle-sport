...
const mockActivities: Activity[] = [
  {
    ...
    name: 'Musculation',
    slug: 'musculation',
    description: 'Renforcez votre masse musculaire avec nos equipements de qualite et les conseils de Coach Toussaint.',
    category: 'force',
    level: 'all',
    duration_minutes: 90,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Fitness',
    slug: 'fitness',
    description: 'Seances dynamiques pour ameliorer votre condition physique generale avec Coach Leo.',
    category: 'cardio',
    level: 'all',
    duration_minutes: 60,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Zumba',
    slug: 'zumba',
    description: 'Dansez, bougez, amusez-vous ! Un cours energique sur des rythmes latinos avec Coach Adonis.',
    category: 'dance',
    level: 'beginner',
    duration_minutes: 90,
    max_capacity: 15,
  ...
  },
  {
    ...
    name: 'Kick Boxing',
    slug: 'kick-boxing',
    description: 'Apprenez les techniques de kick boxing, ameliorez votre endurance et votre confiance avec Coach David.',
  ...
  },
  {
    ...
    name: 'Wushu',
    slug: 'wushu',
    description: 'Art martial chinois traditionnel alliant force, souplesse et discipline avec Maitre Kabore.',
    category: 'martial_arts',
    level: 'all',
    duration_minutes: 60,
    max_capacity: 15,
...
const mockCoaches: Coach[] = [
  {
    ...
    bio: 'Coach Toussaint est present tous les jours de 6h a 21h pour vous accompagner dans vos seances de musculation.',
    is_active: true,
    order: 1,
  },
  {
    ...
    name: 'Coach Adonis',
    photo_url: '',
    certifications: ['Instructeur Zumba'],
    specialties: ['Zumba'],
    bio: 'Coach Adonis anime les cours de Zumba chaque jeudi a 18h dans une ambiance festive et motivante.',
    is_active: true,
    order: 2,
  },
  {
    ...
    specialties: ['Kick Boxing'],
    bio: 'Coach David enseigne le kick boxing les mercredis et samedis a 16h. Intensite et discipline au programme.',
    is_active: true,
    order: 3,
  },
  {
    ...
    specialties: ['Fitness'],
    bio: 'Coach Leo propose des seances de fitness dynamiques les lundis, mercredis et vendredis de 21h a 22h.',
    is_active: true,
    order: 4,
  },
];
...
const mockTransformations: Transformation[] = [
  ...
  },
  {
    ...
    before_image_url: '',
    after_image_url: '',
    testimonial: 'Apres ma grossesse, Eslie Sport m\'a aidee a retrouver la forme avec un programme adapte et bienveillant.',
  ...
  },
  {
    ...
    before_image_url: '',
    after_image_url: '',
    testimonial: 'De debutant complet a 3 seances par semaine. La musculation avec Coach Toussaint a transforme mon physique et mon mental.',
    duration_text: '1 an',
    is_featured: true,
    is_published: true,
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg text-dark-muted max-w-2xl mx-auto leading-relaxed">
            Rejoignez la communaute Eslie Sport et commencez votre transformation des aujourd&apos;hui. Premier cours d&apos;essai offert !
          </p>
